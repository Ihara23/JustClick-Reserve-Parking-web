...
<body>
            ...
            <div class="row">
                <div class="col-xl-6 offset-xl-3">
                    <div class="text-box mt-5 mb-5">
                        <p class="mb-4">You don't have a account? Then please <a class="blue" href="register.php">Sign Up</a></p>

                        <!-- Log In Form -->
                        <form action="source/login-user.php" method="post">                            
    ...
    <div class="copyright">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <p class="p-small">Copyright © <a href="#your-link">JUST-CLICK</a></p>
                </div>
                <!-- end of col -->
            </div>
            <!-- enf of row -->
